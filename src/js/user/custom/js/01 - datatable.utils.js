function renderDatatableFilters(table){
...
function performSearchDt(table, column, value, regex){
    $(table).DataTable()
        .column(column)
        .search(value, regex)
        .draw();
...
function renderDatatableDatePicker(table, selector, regex){
...
function renderDataTableSelect2(table, selector, urlsegment,rows) {
    $(selector)
        .select2({
...
function renderDataTableSelect(table, selector) {
    $(selector)
        .select2({
            placeholder: 'Buscar y filtrar',
            language: "es",
